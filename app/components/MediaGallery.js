...
export default function MediaGallery() {
  ...
  const handlePointerMove = (e) => {
    ...
    // 사용자가 마우스를 당기는 물리값의 60%만 실시간 힌트로 가볍게 기울여 표현
  ...
  return (
    <section className={styles.wideGallerySection}>
      <div className={styles.galleryHeader}>
        <img src="/KAQlogo.png" alt="Reportage Logo" className={styles.galleryLogoAsset} />
      ...
      <div 
        ...
        ref={stageRef}
        style={{ cursor: "pointer", userSelect: "none" }} // 텍스트 긁힘 방지
      >
      ...
      <div className={styles.galleryDotIndicator}>
