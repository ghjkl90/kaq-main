...
const CONTENT = {
  ...
  AR: {
    hero: {
      badge: "المنتجات والخدمات",
      subtitle: [
        "بدءاً من العلاقة بين البشر والذكاء الاصطناعي،",
        "وصولاً إلى أمان وجودة المساحات.",
      ],
      bannerText: ["ذكاء اصطناعي أسهل للبشر،", "جودة أفضل للمساحات."],
    },
    station: {
      title: "K–AI Station",
      subtitle: [
        "ليست خدمة مخصصة فقط لمن يجيدون التقنية —",
        "بل صُممت لتمكين أي شخص من تجربة الذكاء الاصطناعي مباشرة، بغض النظر عن العمر أو الوظيفة أو الاهتمامات.",
      ],
      banner: "/8.png",
      exploreBtn: "عرض المزيد",
      exploreLink: "https://k-ai-station.vercel.app/",
      why: {
        badge: "WHY",
        heading: ["لقد أصبح الذكاء الاصطناعي أقرب،", "لكنه لم يصبح أسهل للجميع."],
        cards: [
          { title: "الناس لا يعرفون من أين يبدؤون.", desc: "يواجه المستخدمون الجدد صعوبة في معرفة ما يجب السؤال عنه." },
          { title: "تتفاوت مستويات المهارة بشكل كبير.", desc: "يتطلب نفس الذكاء الاصطناعي أسئلة وتوضیحات مختلفة بناءً على العمر والوظيفة والغرض." },
          { title: "تختلف احتياجات الوصول أيضاً.", desc: "حجم النص، الإجابات الصوتية، واللغة تتطلب جميعها واجهات مختلفة لمستخدمين مختلفين." },
        ],
      },
      how: {
        badge: "HOW",
        heading: ["لهذا السبب تقوم K–AI Station", "بتخصيص تجربة الذكاء الاصطناعي لتناسب المستخدم،", "بدلاً من إجبار المستخدم على التكيف معها."],
        cards: [
          { title: "أسئلة وإرشادات جاهزة", desc: "يمكن حتى للمستخدمين لأول مرة بدء طرح الأسئلة بسهولة." },
          { title: "اختر التجربة التي تناسبك", desc: "حدد الوضع المناسب لعمرك ووظيفتك وهدفك." },
          { title: "واجهة يمكن للجميع استخدامها", desc: "التوجيه الصوتي والدعم متعدد اللغات يجعلها في متناول الجميع." },
        ],
      },
      modeBadge: "MODE",
      modeHeading: ["تجارب ذكاء اصطناعي مختلفة", "لمختلف الأشخاص"],
      modes: [
        { id: "senior", title: "وضع كبار السن", desc: "بسيط وودود. رفيق ذكاء اصطناعي دافئ في انتظار قصتك.", link: "https://kai-station.com/senior?from=%2Fhome", image: "/11.png" },
        { id: "doran", title: "دوران-دوران للذكاء الاصطناعي", desc: "ابدأ محادثة مريحة مع الذكاء الاصطناعي بضضع نقرات فقط.", link: "https://doran-two.vercel.app/", image: "/12.png" },
        { id: "kids", title: "وضع الأطفال", desc: "أشعل فضولك! انمِ مخيلتك مع صديقك الذكي.", link: "https://kai-station.com/kids?from=%2Fhome", image: "/13.png" },
        { id: "lab", title: "وضع التدريب المختبري", desc: "قم بتنفيذ المهام والتطبيقات العملية المدعومة بالذكاء الاصطناعي مباشرة في الفصل.", link: "https://kai-station.com/?from=%2Fhome", image: "/14.png" },
        { id: "safety", title: "وضع جودة الأمان", desc: "جرب موجهات الذكاء الاصطناعي المتخصصة في الأمان والجودة.", link: "http://openq.co.kr:8082/", image: "/15.png" },
        { id: "ncs", title: "وضع NCS", desc: "استكشف أدلة معايير الوظائف القائمة على الكفاءة بشكل بديهي.", link: "https://kai-station.com/categories/cmq3j1xfy003quvv6j86nh8lb?from=%2Fhome", image: "/16.png" },
      ],
    },
    midCta: {
      badge: "FROM PEOPLE TO SPACE",
      heading: ["نحو اتجاه أفضل لتجربة البشر.", "نحو اتجاه أفضل لجودة المساحات."],
    },
    dsq: {
      title: "DSQ PLATFORM",
      subtitle: ["تحويل بيانات الأمان والجودة المشتتة في الميدان", "إلى بيئة رقمية يمكنك قياسها والتحقق منها وإدارتها."],
      banner: "/9.png",
      exploreBtn: "عرض المزيد",
      exploreLink: "http://openq.co.kr:8082/",
      why: {
        badge: "WHY",
        heading: ["يصعب إدارة الأمان في المساحة", "عندما يكون غير مرئي."],
        cards: [
          { title: "المعلومات مشتتة.", desc: "يتم إدارة نتائج التفتيش والبيانات الميدانية بطرق غير متسقة." },
          { title: "صعب رؤية الوضع الحالي بنظرة سريعة.", desc: "من الصعب رصد تغيرات المخاطر قبل حدوث المشكلة." },
          { title: "السجلات نادراً ما تؤدي إلى تحسين.", desc: "غالباً ما تنتهي عمليات التفتيش كجلات لمرة واحدة." },
        ],
      },
      how: {
        badge: "HOW",
        heading: ["لهذا السبب تربط DSQ PLATFORM", "البيانات الميدانية", "في تدفق واحد متكامل."],
        steps: [
          { label: "SENSE", desc: "جمع المعلومات الميدانية" },
          { label: "MEASURE", desc: "قياس حالة الأمان والجودة" },
          { label: "ANALYZE", desc: "تحليل الحالة والتغيرات" },
          { label: "VISUALIZE", desc: "العرض المرئي على لوحة البيانات" },
          { label: "IMPROVE", desc: "التحقق من المخاطر وإدارة التحسين", wide: true },
        ],
      },
      application: {
        badge: "APPLICATION",
        heading: ["قابل للتطبيق على مجموعة واسعة", "من المساحات اليومية."],
        places: [
          { title: "المرافق متعددة الاستخدامات", desc: "إدارة جودة الأمان للمساحات المشتركة ذات الإقبال الكثيف", image: "/17.png" },
          { title: "الأسواق التقليدية", desc: "تحديد عوامل الخطر والتحقق من الحالة في البيئات المعقدة", image: "/18.png" },
          { title: "مناطق المدارس", desc: "الإدارة المستمرة للمساحات التي يكون فيها الأمان الأكثر أهمية", image: "/19.png" },
        ],
      },
    },
    finalCta: {
      text: ["اصنع المعيار الجديد لتجربة الذكاء الاصطناعي", "وجودة الأمان جنباً إلى جنب مع KAQ."],
      btn: "اتصل بنا",
    },
    modal: {
      title: "Application",
