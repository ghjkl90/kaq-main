    ...
    <div ref={topRef} style={{ backgroundColor: '#fff', color: '#111', padding: '140px 20px 120px 20px', minHeight: '100vh', overflowX: 'hidden' }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div className="vision-wrapper">
            ...
            >
              <div style={{ padding: '0 4px' }}>
                <h3 style={{ fontSize: 'clamp(1.5rem, 3vw, 2rem)', fontWeight: '800', color: '#0052ff', margin: '0 0 16px 0', letterSpacing: '-1px' }}>
                  Our Vision
                </h3>
                <p style={{ color: '#333', fontSize: '15px', fontWeight: '500', lineHeight: '1.75', margin: 0, wordBreak: 'keep-all' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', paddingLeft: '4px', borderTop: '1px solid #f0f0f0', paddingTop: '24px' }}>
                <p style={{ color: '#111', fontSize: '16px', fontWeight: '700', lineHeight: '1.65', margin: 0, letterSpacing: '-0.5px', wordBreak: 'keep-all' }}>
                  KAQ는 고객과 함께 새로운 가치를 만드는 데 도전합니다. 고객의 AI 저작권과 안전품질 대시보드 가치를 보호합니다.
                </p>
                <p style={{ color: '#555', fontSize: '15px', lineHeight: '1.75', margin: 0, wordBreak: 'keep-all' }}>
        ...
        <div 
          ...
          style={{
            ...
            transform: careersVisible ? 'translateY(0)' : 'translateY(40px)',
            transition: 'all 0.8s cubic-bezier(0.25, 1, 0.5, 1)',
        ...
        >
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            <h2 style={{ fontSize: 'clamp(1.5rem, 3vw, 2rem)', fontWeight: '800', marginBottom: '14px', letterSpacing: '-1px', color: '#0052ff' }}>
              Careers
            </h2>
            <p style={{ fontSize: '15px', color: '#555', lineHeight: '1.75', marginBottom: '28px', maxWidth: '800px', wordBreak: 'keep-all' }}>
                ...
                return (
                  ...
                  >
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                      ...
                      <h3 style={{ fontSize: 'clamp(1rem, 2.5vw, 1.25rem)', fontWeight: '700', margin: '0', color: '#111', letterSpacing: '-0.5px', wordBreak: 'keep-all' }}>
                        {job.title}
                      </h3>
                    </div>
      ...
      {isApplyOpen && (
        <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', backgroundColor: 'rgba(0,0,0,0.4)', display: 'flex', justifyContent: 'center', alignItems: 'center', zIndex: 1000 }}>
          <div style={{ backgroundColor: '#fff', padding: '40px', borderRadius: '12px', width: '100%', maxWidth: '500px', boxShadow: '0 10px 30px rgba(0,0,0,0.1)', position: 'relative', color: '#111' }}>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                ...
                <input type="text" required placeholder="홍길동" value={name} onChange={(e) => setName(e.target.value)} style={{ padding: '10px', border: '1px solid #ccc', borderRadius: '6px', fontSize: '15px' }} />
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                <label style={{ fontSize: '14px', fontWeight: 'bold' }}>생년월일 *</label>
                <input type="date" required value={birthDate} onChange={(e) => setBirthDate(e.target.value)} style={{ padding: '10px', border: '1px solid #ccc', borderRadius: '6px', fontSize: '15px' }} />
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                <label style={{ fontSize: '14px', fontWeight: 'bold' }}>국적 *</label>
                <input type="text" required placeholder="대한민국" value={nationality} onChange={(e) => setNationality(e.target.value)} style={{ padding: '10px', border: '1px solid #ccc', borderRadius: '6px', fontSize: '15px' }} />
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                <label style={{ fontSize: '14px', fontWeight: 'bold' }}>이력서 / 포트폴리오 링크 주소</label>
                <input type="url" placeholder="구글 드라이브, 노션 등 공유 링크 주소를 넣어주세요." value={fileLink} onChange={(e) => setFileLink(e.target.value)} style={{ padding: '10px', border: '1px solid #ccc', borderRadius: '6px', fontSize: '14px' }} />
              </div>
              <button type="submit" style={{ backgroundColor: '#0052ff', color: '#fff', border: 'none', borderRadius: '6px', padding: '14px', fontSize: '16px', fontWeight: 'bold', cursor: 'pointer', marginTop: '10px', transition: 'background-color 0.2s' }}>지원서 제출하기</button>
            </form>
          </div>
        </div>
      )}
