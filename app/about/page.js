...
export default function AboutPage() {
  ...
  useEffect(() => {
    ...
    const leftObserver = new IntersectionObserver(([entry]) => { if (entry.isIntersecting) setLeftVisible(true); }, observerOptions);
    const rightObserver = new IntersectionObserver(([entry]) => { if (entry.isIntersecting) setRightVisible(true); }, observerOptions);
    const careersObserver = new IntersectionObserver(([entry]) => { if (entry.isIntersecting) setCareersVisible(true); }, observerOptions);
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div className="vision-wrapper">
            ...
            >
              <div style={{ padding: '0 4px' }}>
                <h3 style={{ fontSize: 'clamp(1.5rem, 3vw, 2rem)', fontWeight: '800', color: '#0052ff', margin: '0 0 24px 0', letterSpacing: '-1px' }}>
                  Our Vision
                </h3>
        ...
        >
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            <h2 style={{ fontSize: 'clamp(1.5rem, 3vw, 2rem)', fontWeight: '800', marginBottom: '16px', letterSpacing: '-1px', color: '#0052ff' }}>
              Careers
            </h2>
          ...
          <div style={{ backgroundColor: '#fff', padding: '40px', borderRadius: '8px', width: '100%', maxWidth: '500px', boxShadow: '0 10px 30px rgba(0,0,0,0.1)', position: 'relative', color: '#111' }}>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                ...
                <input type="date" required value={birthDate} onChange={(e) => setBirthDate(e.target.value)} style={{ padding: '10px', border: '1px solid #ccc', borderRadius: '4px', fontSize: '15px' }} />
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
